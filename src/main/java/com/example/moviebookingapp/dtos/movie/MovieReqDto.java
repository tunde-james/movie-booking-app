...
public record MovieReqDto(
        @NotBlank(message = "Title is required") @Size(max = 200, message = "Title cannot exceed 200 characters")
        String title,
        ...
        @NotNull(message = "Release date is required") @FutureOrPresent(message = "Release date cannot be in the past")
        LocalDate releaseDate,

        @NotNull(message = "Language is required") Language language,

        @NotNull(message = "Rating is required") MovieRating rating,

        @NotNull(message = "Status is required") MovieStatus movieStatus,
