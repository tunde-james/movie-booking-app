...
class AuditoriumControllerValidationTest {
    ...
    void addAuditoriumReturnsProblemDetailsWhenRequestIsInvalid() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/cinemas/10/auditoriums")
                ...
                .andExpect(jsonPath("$.errors[*].field", hasItem("capacity")));
    }
}
